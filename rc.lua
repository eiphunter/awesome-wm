...
-- }}}
 ...
 tags = {
   names  = { "main", "www", "code", "irc", "hack", "gfx", 7, 8, 9 },
...
vicious.register(gmailwidget, vicious.widgets.gmail,"<span color='#010101'>${count}</span>", 260)
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        mylayoutbox[s],
        mytextclock,
        separator, gmailwidget, spacer , gmailicon,
